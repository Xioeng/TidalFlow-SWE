...
class TestSWESolver:
    """Test SWESolver setup and configuration behavior."""

    def test_init_sets_domain_from_config(self, basic_config):
    ...
    def test_set_time_parameters_updates_config(self, basic_config):
    ...
    def test_set_domain_updates_grid_and_config(self, basic_config):
    ...
    def test_set_bathymetry_disables_provider(self, basic_config):
    ...
    def test_set_initial_condition_disables_provider(self, basic_config):
    ...
    def test_initialize_data_from_providers_requires_domain(self, basic_config):
    ...
    def test_initialize_data_from_providers_populates_arrays(self, basic_config):
    ...
    def test_check_arrays_sanity_set_detects_wrong_shape(self, basic_config):
    ...
    def test_validate_swe_configuration_raises_for_bad_shapes(self, basic_config):
