...
class TestSWEResult:
    """Test SWEResult serialization and conversion."""

    def test_to_dict_returns_expected_structure(self, basic_config):
    ...
    def test_save_and_load_round_trip(self, tmp_path, basic_config):
